...
def import_train_configuration(config_file):
    ...
    config['total_ep'] = content['simulation'].getint('total_ep')
...
def set_sumo(gui, sumocfg_file_name, max_steps):
    """
    Configure various parameter of SUMO
    """
    ...
    # setting the cmd mode or visual mode
    if gui == False:
...
def set_test_path(models_path_name, model_n):
    ...
    if os.path.isdir(model_folder_path):
        ...
        sys.exit('The model number specified does not exist in the models folders')